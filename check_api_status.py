...
print("Project: gen-lang-client-0950802038")
print("Service Account: lapio-28@gen-lang-client-0950802038.iam.gserviceaccount.com\n")
...
try:
    ...
    parent = 'projects/gen-lang-client-0950802038'
